...
function p2x_cai_sensitivity_analysis()
    ...
    ATP_t1 = 2; ATP_t2 = 60; t_max = 62;% unit in seconds
    ...
    legend('$$\overline{J}_{NCX}$$', '$$\overline{J}_{PMCA}$$', '$${\alpha}_{1h}$$', '$${\alpha}_{2h}$$', '$${\alpha}_{3h}$$', '$${\beta}_{1h}$$', '$${\beta}_{2h}$$', '$${\beta}_{3h}$$', '$${\beta}_{4h}$$', '$${g}_{h}$$', '$${\alpha}_{1r}$$', '$${\alpha}_{2r}$$', '$${\alpha}_{3r}$$', '$${\beta}_{1r}$$', '$${\beta}_{2r}$$', '$${\beta}_{3r}$$', '$${\beta}_{4r}$$', '$${g}_{r}$$', 'Interpreter', 'latex');
